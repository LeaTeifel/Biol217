...
#SBATCH -D ./
#SBATCH --output=/work_beegfs/sunam235/Day5/5_anvio_profiles/taxonomy.out
#SBATCH --error=/work_beegfs/sunam235/Day5/5_anvio_profiles/taxonomy.out
...
#cd /work_beegfs/sunam235/Day5/5_anvio_profiles/ARCHAEA_BIN_REFINEMENT
...
#anvi-run-scg-taxonomy -c /work_beegfs/sunam235/Day5/contigs.db -T 20 -P 2

anvi-estimate-scg-taxonomy -c /work_beegfs/sunam235/Day5/contigs.db --metagenome-mode
