...
#SBATCH -D ./
#SBATCH --output=/work_beegfs/sunam235/day3/5_anvio-profiles/anviomerge.out
#SBATCH --error=/work_beegfs/sunam235/day3/5_anvio-profiles/anviomerge.err
...
anvi-merge /work_beegfs/sunam235/day3/5_anvio-profiles/profiling/BGR_130305/PROFILE.db /work_beegfs/sunam235/day3/5_anvio-profiles/profiling/BGR_130527/PROFILE.db /work_beegfs/sunam235/day3/5_anvio-profiles/profiling/BGR_130708/PROFILE.db -o /work_beegfs/sunam235/day3/5_anvio-profiles/profiling/merged_profiles -c /work_beegfs/sunam235/day3/5_anvio-profiles/contigs.db --enforce-hierarchical-clustering
